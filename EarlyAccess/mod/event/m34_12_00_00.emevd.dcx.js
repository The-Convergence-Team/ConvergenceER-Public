...
$Event(50, Default, function() {
    ...
    InitializeCommonEvent(0, 90005250, 34120215, 34122210, 0, -1);
    InitializeCommonEvent(0, 90005250, 34120306, 34122211, 0, -1);
    InitializeCommonEvent(0, 90005250, 34120350, 34122212, 0, -1);
    InitializeCommonEvent(0, 90005250, 34120351, 34122212, 0, -1);
});
...
$Event(34122800, Restart, function() {
    ...
    SetEventFlagID(34120800, ON);
    SetEventFlagID(9264, ON);
    if (PlayerIsInOwnWorld()) {
        SetEventFlagID(61264, ON);
    }
});
...
L0:
    ...
    EnableCharacterInvincibility(34120800);
...
L2:
    ...
    DisableCharacterInvincibility(34120800);
