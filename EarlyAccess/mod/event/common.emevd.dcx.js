...
$Event(9008001, Default, function() {
    ...
    for (let i = 0; i <= 10; i++) {
        ...
        $InitializeEvent(1188 + i, 9006006, 23650000 + i, 40022, 40302, 0); // [CER] Twin Jellyfish
        ...
        $InitializeEvent(1210 + i, 9006006, 42600000 + i, 40042, 40304, 0); // [CER] Turtle
...
$Event(9006024, Restart, function(foundItemType, foundItem, replacingItemType, replacingItem) {
    DisableNetworkSync();
    WaitFor(PlayerHasItem(foundItemType, foundItem) && !PlayerHasItemIncludingBBox(foundItemType, foundItem));
