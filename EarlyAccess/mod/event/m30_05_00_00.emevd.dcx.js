...
$Event(30052850, Restart, function() {
    ...
    SetEventFlagID(30050850, ON);
    if (PlayerIsInOwnWorld()) {
        SetEventFlagID(61221, ON);
    }
    SetEventFlagID(9221, ON);
});
...
L0:
    ...
    EnableCharacterInvincibility(30050850);
    WaitFor(EventFlag(30052855) && InArea(10000, 30052855));
    EnableCharacterAI(30050850);
    DisableCharacterInvincibility(30050850);
