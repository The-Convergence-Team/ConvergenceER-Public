...
$Event(0, Default, function() {
    ...
    InitializeCommonEvent(0, 90005621, 31210800, 31211578);
});
...
$Event(31212800, Restart, function() {
    ...
    SetEventFlagID(31210800, ON);
    SetEventFlagID(9243, ON);
    if (PlayerIsInOwnWorld()) {
        SetEventFlagID(61243, ON);
    }
});
...
L0:
    if (!EventFlag(31210801)) {
        EnableCharacterInvincibility(31210800);
        WaitFor(
...
L2:
    DisableCharacterInvincibility(31210800);
