...
$Event(0, Default, function() {
    ...
    // Passive enemies for servant of rot
    InitializeCommonEvent(0, 98005301, 60924, 1048380801);
    InitializeCommonEvent(1, 98005301, 60924, 1048380802);
    InitializeCommonEvent(2, 98005301, 60924, 1048380803);
    InitializeCommonEvent(3, 98005301, 60924, 1048380804);
    InitializeCommonEvent(4, 98005301, 60924, 1048380805);
    InitializeCommonEvent(5, 98005301, 60924, 1048380806);
    InitializeCommonEvent(6, 98005301, 60924, 1048380807);
});
