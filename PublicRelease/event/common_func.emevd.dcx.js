...
// Enemy Activation - Enemy, Region, SecondsTillAnim, ForcedAnim (default: -1)
...
// One Time Kill Handler with item - EventFlag, EntityID, ItemLotParam_map, DelayInSeconds, bool disableItemDrop
...
// One Time Kill Handler with item (DLC) - EventFlag, EntityID, ItemLotParam_map, DelayInSeconds, bool disableItemDrop
...
// Wickerman - Set Leg HP | Never combined with 90005431 (DLC) - EntityID
...
// Wickerman - Set Leg HP to MAX | Never combined with 90005430 (DLC) - EntityID
...
// Wickerman - Modify AI based on range of player (DLC) - EntityID, Eventflag
...
// Wickerman - Stagger Handler [Right Leg] | Never combined with 90005431 (DLC) - EntityID, Stagger 1 Eventflag, Stagger 2 Eventflag, Stagger 3 Eventflag
...
// Wickerman - Stagger Handler [Left Leg] | Never combined with 90005431 (DLC) - EntityID, Stagger 1 Eventflag, Stagger 2 Eventflag, Stagger 3 Eventflag
...
// Wickerman - Hefty Fire Pot Handler (DLC) - EntityID, Pot 1 Eventflag, Pot 2 Eventflag, Pot 3 Eventflag, Pot 4 Eventflag
...
// Wickerman - ? (DLC) - EntityID, Region A, Region B
...
// Wickerman - Hefty Furnace Pot Handler (DLC) - EntityID, Pot 1 Eventflag, Pot 2 Eventflag
...
// Wickerman - Anger of the Fell God Handler (DLC) - EntityID
$Event(90005438, Restart, function(X0_4) {
    WaitFor(CharacterBackreadStatus(X0_4) && CharacterHasSpEffect(X0_4, 20011136));
    ForceAnimationPlayback(X0_4, 20009, false, true, false);
});
...
// One way door - Event Flag, Door Entity ID, ObjActEventFlag, ObjActParamID, bool: shouldDisableObjAct
...
// One way door - EventFlag, Open Region, Close Region
...
$Event(90005620, Default, function(X0_4, X4_4, X8_4, X12_4, X16_4, X20_4, X24_4) {
    DisableAsset(X4_4); // Imp Statue
    DisableAsset(X8_4); // Key 1
    DisableAsset(X12_4); // Key 2
    SetEventFlagID(X0_4, ON); // Disable Fogwall
    EndEvent();
...
L1:
    ...
    if (!MapLoaded(X20_1, X21_1, X22_1, X23_1)) {
        WarpPlayer(X20_1, X21_1, X22_1, X23_1, X16_4, 0);
    }
    else {
...
// Catacomb Door Lever - Eventflag, Door EntityID, ObjAct EntityID, ObjAct Eventflag, sObjAct ParamID 
...
$Event(90005727, Restart, function(X0_4, X4_4, X8_4, X12_4, X16_4) {
    ...
    //if (CharacterHasSpEffect(X4_4, 9603)) { // Was in old version of modded file, unsure if it's neccessary
    //    ForceAnimationPlayback(X4_4, 20009, false, false, false, Equal, 1);
    //}
...
// Boss BGM Handler - Boss Defeat Flag, bgmBossConvParamId, StartWaitFlag 1, StartWaitFlag 2 (Coop), StartWaitFlag 3 (Optional), PhaseChangeFlag, Unk Bool, UseStop1 Bool
...
L0:
    ...
    if (!EventFlag(X0_4)) {
        ...
        //SetEventFlagID(X8_4, OFF); // THIS BREAKS BOSS VOICE LINES
        WaitFor(EventFlag(X0_4));
    }
L1:
...
// Custom Boss Start Event
$Event(90005876, Restart, function(X0_4, X4_4, X8_4, X12_4, X16_4) {
    if (EventFlag(X0_4)) {
        DisableCharacter(X0_4);
        DisableCharacterCollision(X0_4);
...
L0:
    ...
    DisableCharacterInvincibility(X0_4);
    SetNetworkUpdateRate(X0_4, true, CharacterUpdateFrequency.AlwaysUpdate);
    WaitFor(ElapsedSeconds(4) || HasDamageType(X0_4, 10000, DamageType.Unspecified) || EntityInRadiusOfEntity(X0_4, 10000, 4, 1));
    EnableCharacterAI(X0_4);
...
//Erdtree Boss Zone Handler - Boss Defeat Flag, Zoning Event Flag, Outer Zone
$Event(90005890, Restart, function(X0_4, X4_4, X8_4) {
    EndIf(EventFlag(X0_4));
  
    if (EventFlag(X4_4) && !InArea(10000, X8_4))
        SetEventFlagID(X4_4, OFF);
...
$Event(90005891, Restart, function(X0_4, X4_4, X8_4) {
    DisableAsset(X8_4);
    EndIf(EventFlag(X0_4));
...
$Event(90005892, Restart, function(X0_4, X4_4, X8_4, X12_4, X16_4, X20_4, X24_4, X28_4, X32_4) {
    DisableAsset(X8_4);
    DisableAsset(X12_4);
    DisableAsset(X16_4);
    DisableAsset(X20_4);
...
//Change Enemy Team if Flag is True (stating class locations)
$Event(98005301, Restart, function(X0_4, X4_4) {
    EndIf(!EventFlag(X0_4) || CharacterDead(X4_4));
...
//Force Time to Night
$Event(98005302, Restart, function(X0_4) {
    WaitFor(InArea(10000, X0_4));
...
// Inverted Flag Handler On - Flag to evaluate, Flag for output
$Event(98005303, Default, function(X0_4, X4_4) {
    WaitFor(EventFlag(X0_4) && EventFlag(X4_4));
    SetEventFlagID(X4_4, OFF);
    RestartEvent();
});

// Inverted Flag Handler Off - Flag to evaluate, Flag for output
$Event(98005304, Default, function(X0_4, X4_4) {
    WaitFor(!EventFlag(X0_4) && !EventFlag(X4_4));
    SetEventFlagID(X4_4, ON);
    RestartEvent();
});

// Burried Treasure (No Chest) - Buried Flag, Pickup Flag, Asset, Item, Rarity VFX
$Event(98005305, Default, function(X0_4, X4_4, X8_4, X12_4, X16_4) {
    EndIf(EventFlag(X4_4));
    
    if (!EventFlag(X0_4)) {
        CreateAssetfollowingSFX(X8_4, 100, X16_4);
        WaitFor(ActionButtonInArea(6255, X8_4) || EventFlag(X0_4));
        SetEventFlagID(X0_4, ON);
        
        WaitFixedTimeFrames(10);
        SpawnOneshotSFX(TargetEntityType.Asset, X8_4, 90, 101111);
        SpawnOneshotSFX(TargetEntityType.Asset, X8_4, 90, 530213);
        WaitFixedTimeFrames(20);
        SpawnOneshotSFX(TargetEntityType.Asset, X8_4, 90, 101112);
        SpawnOneshotSFX(TargetEntityType.Asset, X8_4, 90, 530213);
        WaitFixedTimeFrames(20);
        SpawnOneshotSFX(TargetEntityType.Asset, X8_4, 90, 101113);
        SpawnOneshotSFX(TargetEntityType.Asset, X8_4, 90, 530172);
        PlaySE(X8_4, SoundType.Asset, 643836);
        
        DeleteAssetfollowingSFX(X8_4, false);
    }
    CreateAssetfollowingSFX(X8_4, 90, X16_4);
    WaitFor(ActionButtonInArea(4110, X8_4));
    AwardItemLot(X12_4);
    DeleteAssetfollowingSFX(X8_4, false);
    EndEvent();
});

// Burried Treasure (Chest) - Buried Flag, Interactable, Chest, ObjAct ID (untested)
$Event(98005306, Default, function(X0_4, X4_4, X8_4, X12_4) {
    EndIf(EventFlag(X0_4));
    IssueShortWarpRequest(X8_4, TargetEntityType.Asset, X4_4, 100);
    DisableObjAct(X8_4, X12_4);
    ...
    SpawnOneshotSFX(TargetEntityType.Asset, X8_4, 90, 101114);
    SpawnOneshotSFX(TargetEntityType.Asset, X8_4, 90, 530211);
    SpawnOneshotSFX(TargetEntityType.Asset, X8_4, 90, 450431);
    SpawnOneshotSFX(TargetEntityType.Asset, X8_4, 90, 450433);
    
    IssueShortWarpRequest(X8_4, TargetEntityType.Asset, X4_4, 90);
    EnableObjAct(X8_4, X12_4);
    EndEvent();
});

// Way-Gate - Asset, areaID, blockID, regionID, indexID, initialAreaEntityID, (optional) awaited eventflag
$Event(98005307, Default, function(X0_4, X4_4, X8_4, X12_4, X16_4, X20_4, X24_4) {
    DisableNetworkSync();
    if (Signed(X24_4) != 0)
        WaitFor(EventFlag(X24_4));
...
// Enemy Crates - enemyEntityID, assetEntityID, (optional) region, (optional) itemLotID
$Event(98005308, Restart, function(X0_4, X4_4, X8_4, X12_4) {
    DisableCharacterGravity(X0_4);
    DisableCharacterCollision(X0_4);
    DisableCharacterAI(X0_4);
    SetSpEffect(X0_4, 10124); // Fade
    RequestAssetRestoration(X4_4); // Just to be sure
    if (Signed(X8_4) > 0) {
        brokeCrate |= AssetDestroyed(X4_4, Equal, 1);
        WaitFor(brokeCrate || InArea(10000, X8_4));
        if (!brokeCrate.Passed)
            RequestAssetDestruction(X4_4, 1);
    }
    else WaitFor(AssetDestroyed(X4_4, Equal, 1));
    ...
    EnableCharacterAI(X0_4);
    WaitFixedTimeFrames(1);
    RotateCharacter(X0_4, 10000, -1, false);
...
// Custom Playzone - bossDefeatFlag, regionEntityID, spawnPointEntityID
$Event(98005309, Restart, function(X0_4, X4_4, X8_4) {
    EndIf(EventFlag(X0_4) || !InArea(10000, X4_4));
...
$Event(9005995, Restart, function(X0_4, X4_4, X8_4) {
    ...
    CreateAssetfollowingSFX(X4_4, 200, 806872); //Portal FX 806872 525310
    WaitFor(AnyBatchEventFlags(97000, 97027));
    if (!EventFlag(62002) && AnyBatchEventFlags(97021, 97027)) { // Open up DLC map stuff
        SetEventFlagID(62002, ON);
        SetEventFlagID(82002, ON);
    }
    SetEventFlagID(1099000105, ON);
    
    // - - - Visuals - - -
    SpawnOneshotSFX(TargetEntityType.Asset, X4_4, 210, 304052); //Rune FX
    ForceAnimationPlayback(10000, 60010, false, false, false);
    WaitFixedTimeSeconds(1);
    CreateAssetfollowingSFX(X4_4, 200, 525315); //Wind FX
    WaitFixedTimeSeconds(1);
    ...
    //East Limgrave
    if (EventFlag(97000)) {
        SetEventFlagID(97000, OFF);
        if (EventFlag(1045370800))
            WarpPlayer(60, 45, 37, 0, 1045372650, 60);
        else WarpPlayer(60, 45, 37, 0, 1045372651, 60);
    }
    //Weeping Peninsula
    else if (EventFlag(97001)) {
        SetEventFlagID(97001, OFF);
        if (EventFlag(1043330800))
            WarpPlayer(60, 43, 33, 0, 1043332650, 60);
        else WarpPlayer(60, 43, 33, 0, 1043332651, 60);
    }
    //Stormhill
    else if (EventFlag(97019)) {
        SetEventFlagID(97019, OFF); 
        if (EventFlag(1041370800))
            WarpPlayer(60, 41, 37, 0, 1041370650, 60);
        else WarpPlayer(60, 41, 37, 0, 1041370651, 60);
    }
    // - - - Liurnia - - -
    //South Liurnia
    else if (EventFlag(97005)) {
        SetEventFlagID(97005, OFF);
        if (EventFlag(1039420800))
            WarpPlayer(60, 39, 42, 0, 1039422650, 60);
        else WarpPlayer(60, 39, 42, 0, 1039422651, 60);
    }
    //West Liurnia
    else if (EventFlag(97006)) {
        SetEventFlagID(97006, OFF);
        if (EventFlag(1048370800))
            WarpPlayer(60, 33, 43, 0, 1033432650, 60);
        else WarpPlayer(60, 33, 43, 0, 1033432651, 60);
    }
    //North Liurnia
    else if (EventFlag(97007)) {
        SetEventFlagID(97007, OFF); 
        if (EventFlag(1038480800))
            WarpPlayer(60, 38, 48, 0, 1038482650, 60);
        else WarpPlayer(60, 38, 48, 0, 1038482651, 60);
    }
    // - - - Caelid - - -
    //West Caelid
    else if (EventFlag(97002)) {
        SetEventFlagID(97002, OFF); 
        if (EventFlag(1047400800))
            WarpPlayer(60, 47, 40, 0, 1047402650, 60);
        else WarpPlayer(60, 47, 40, 0, 1047402651, 60);
    }
    //South Caelid
    else if (EventFlag(97004)) {
        SetEventFlagID(97004, OFF); 
        if (EventFlag(1048370800))
            WarpPlayer(60, 48, 37, 0, 1048372650, 60);
        else WarpPlayer(60, 48, 37, 0, 1048372651, 60);
    }
    //East Caelid
    else if (EventFlag(97003)) {
        SetEventFlagID(97003, OFF); 
        if (EventFlag(1051400800))
            WarpPlayer(60, 51, 40, 0, 1051402650, 60);
        else WarpPlayer(60, 51, 40, 0, 1051402651, 60);
    }
    // - - - Mt. Gelmnir - - -
    //West Mt. Gelmir
    else if (EventFlag(97008)) {
        SetEventFlagID(97008, OFF);
       if (EventFlag(1036520800))
            WarpPlayer(60, 36, 52, 0, 1036522650, 60);
       else WarpPlayer(60, 36, 52, 0, 1036522651, 60);
    }
    //East Mt. Gelmir
    else if (EventFlag(97009)) {
        SetEventFlagID(97009, OFF); 
        if (EventFlag(1037540810))
            WarpPlayer(60, 37, 54, 0, 1037542650, 60);
        else WarpPlayer(60, 37, 54, 0, 1037542651, 60);
    }
    // - - - Altus - - -
    //South Altus
    else if (EventFlag(97011)) {
        SetEventFlagID(97011, OFF);
        if (EventFlag(1043500800))
            WarpPlayer(60, 43, 50, 0, 1043500600, 60);
        else WarpPlayer(60, 43, 50, 0, 1043500601, 60);
    }
    //Central Altus
    else if (EventFlag(97010)) {
        SetEventFlagID(97010, OFF); 
        if (EventFlag(1041530800))
            WarpPlayer(60, 41, 53, 0, 1041532650, 60);
        else WarpPlayer(60, 41, 53, 0, 1041532652, 60);
    }
    //East Altus
    else if (EventFlag(97012)) {
        SetEventFlagID(97012, OFF);
        if (EventFlag(1044530810))
            WarpPlayer(60, 44, 53, 0, 1044532650, 60);
        else WarpPlayer(60, 44, 53, 0, 1044532651, 60);
    }
    // - - - Mountains - - -
    //Forbidden Lands
    else if (EventFlag(97020)) {
        SetEventFlagID(97020, OFF);
        if (EventFlag(1049520850))                
            WarpPlayer(60, 49, 52, 0, 1049522650, 60);
        else WarpPlayer(60, 49, 52, 0, 1049522651, 60);
    }
    //North Mountaintops
    else if (EventFlag(97013)) {
        SetEventFlagID(97013, OFF);
        if (EventFlag(1052560800))                
            WarpPlayer(60, 52, 56, 0, 1052562650, 60);
        else WarpPlayer(60, 52, 56, 0, 1052562651, 60);
    }
    //South Mountaintops
    else if (EventFlag(97014)) {
        SetEventFlagID(97014, OFF); 
        if (EventFlag(1051530800))                
            WarpPlayer(60, 51, 53, 0, 1051530600, 60);
        else WarpPlayer(60, 51, 53, 0, 1051530601, 60);
    }
    //Consecrated Snowfield
    else if (EventFlag(97015)) {
        SetEventFlagID(97015, OFF);
        if (EventFlag(1049570800))
            WarpPlayer(60, 49, 57, 0, 1049570600, 60);
        else WarpPlayer(60, 49, 57, 0, 1049570601, 60);
    }
    // - - - Underground - - -
    //Siofra River
    else if (EventFlag(97017)) {
        SetEventFlagID(97017, OFF);
        if (EventFlag(12070805))
             WarpPlayer(12, 7, 0, 0, 12070600, 60);
        else WarpPlayer(12, 7, 0, 0, 12070601, 60);
    }
    //Ainsel River
    ...
    //Deeproot Depths
        ...
        SetEventFlagID(97018, OFF);
        if (EventFlag(12030860))
             WarpPlayer(12, 3, 0, 0, 12030600, 60);
        else WarpPlayer(12, 3, 0, 0, 12030601, 60);
    }
    // - - - Realm of Shadow - - -
    // Gravesite Plain - Southern Cliffside
    else if (EventFlag(97021)) {
        SetEventFlagID(97021, OFF);
        if (EventFlag(2047400800))
             WarpPlayer(61, 47, 40, 0, 2047400600, 120500);
        else WarpPlayer(61, 47, 40, 0, 2047400601, 120500);
    }
    // Cerulean Bluffs
    else if (EventFlag(97022)) {
        SetEventFlagID(97022, OFF);
        if (EventFlag(2048380860))
             WarpPlayer(61, 48, 38, 0, 2048380600, 120500);
        else WarpPlayer(61, 48, 38, 0, 2048380601, 120500);
    }
    // Shaman Village
    else if (EventFlag(97023)) {
        SetEventFlagID(97023, OFF);
        if (EventFlag(2051470800))
             WarpPlayer(61, 51, 47, 0, 2051470600, 120500);
        else WarpPlayer(61, 51, 47, 0, 2051470601, 120500);
    }
    // Minor Erdtree Cave
    else if (EventFlag(97024)) {
        SetEventFlagID(97024, OFF);
        WarpPlayer(61, 49, 45, 0, 2049450600, 120500);
        if (EventFlag(2049450850))
             WarpPlayer(61, 49, 45, 0, 2049450600, 120500);
        else WarpPlayer(61, 49, 45, 0, 2049450601, 120500);
    }
    // Rauh Steppes
    else if (EventFlag(97025)) {
        SetEventFlagID(97025, OFF);
        if (EventFlag(2047470800))
             WarpPlayer(61, 47, 47, 0, 2047470600, 120500);
        else WarpPlayer(61, 47, 47, 0, 2047470601, 120500);
    }
    // Dragon Resting Grounds
    else if (EventFlag(97026)) {
        SetEventFlagID(97026, OFF);
        if (EventFlag(2049410850))
             WarpPlayer(61, 49, 41, 0, 2049410600, 120500);
        else WarpPlayer(61, 49, 41, 0, 2049410601, 120500);
    }
    // Abyssal Overlook
    else if (EventFlag(97027)) {
        SetEventFlagID(97027, OFF);
        WarpPlayer(61, 51, 44, 0, 2051440600, 120500);
        if (EventFlag(2051440850))
             WarpPlayer(61, 51, 44, 0, 2051440600, 120500);
        else WarpPlayer(61, 51, 44, 0, 2051440601, 120500);
    }
...
//Custom Killbox
$Event(9005999, Restart, function(X0_4) {
    DisableNetworkSync();
    WaitFor(InArea(10000, X0_4));
    SetSpEffect(10000, 9000005);
    WaitFixedTimeFrames(1);
    ForceCharacterDeath(10000, false);
    ForceAnimationPlayback(10000, 4100, true, false, true);
});

// VFX Tie to Flag - EventFlag, AssetMapSFXRegion
$Event(90006800, Restart, function(X0_4, X4_4) {
    if (EventFlag(X0_4)) {
...
//Weapon Duplication Consumable Manager - Mausoleum Entity ID, Altar Entity ID, Mausoleum Used Event Flag
$Event(9006900, Default, function(X0_4, X4_4, X8_4) {
    SetEventFlagID(1099002000, OFF);
    ClearEventValue(1099002010, 2);
    ClearEventValue(1099002020, 2);
    GotoIf(L0, EventFlag(X8_4));
    
    IfActionButtonInArea(MAIN, 6430, X4_4);
    
    // Visuals
    if (!MapLoaded(12, 3, 0, 0))
        ChangeWeather(Weather.HeavyFog, 30, false);
    
    if (!EventFlag(1099002001))
    {
        RotateCharacter(10000, X4_4, 60560, false); // 157 frames
        WaitFixedTimeFrames(30);
        CreateAssetfollowingSFX(X4_4, 2, 402030);
        WaitFixedTimeFrames(20);
        SetSpEffect(10000, 335);
        SetSpEffect(10000, 336);
        WaitFixedTimeFrames(107);
    ...
    DisplayGenericDialogAndSetEventFlags(60075, PromptType.YESNO, NumberofOptions.TwoButtons, X4_4, 2.5, 1099002000, 6001, 6001);
    if (!EventFlag(1099002000)) {
        WaitFixedTimeSeconds(1);
    ...
    if (CompareEventValue(1099002010, 2, Equal, 0) && CompareEventValue(1099002020, 2, Equal, 0)) { // Restart if failed
        DisplayBlinkingMessage(60090);
        WaitFixedTimeSeconds(3);
        RestartEvent();
    }
    ...
    SetSpEffect(10000, 341);
    CreateAssetfollowingSFX(X4_4, 2, 804);
    
    if (CompareEventValue(1099002010, 2, Greater, 0) && CompareEventValue(1099002020, 2, Greater, 0)) { // If two weapons were duplicated, apply the rarities individually
        CreateAssetfollowingSFX(X4_4, 4, 331701);
        if (CompareEventValue(1099002010, 4, Equal, 1))
            CreateAssetfollowingSFX(X4_4, 4, 6101);
        else if (CompareEventValue(1099002010, 4, Equal, 2))
            CreateAssetfollowingSFX(X4_4, 4, 6102);
        else if (CompareEventValue(1099002010, 4, Equal, 3))
            CreateAssetfollowingSFX(X4_4, 4, 6103);
        
        CreateAssetfollowingSFX(X4_4, 5, 331701);
        if (CompareEventValue(1099002020, 4, Equal, 1))
            CreateAssetfollowingSFX(X4_4, 5, 6101);
        else if (CompareEventValue(1099002020, 4, Equal, 2))
            CreateAssetfollowingSFX(X4_4, 5, 6102);
        else if (CompareEventValue(1099002020, 4, Equal, 3))
            CreateAssetfollowingSFX(X4_4, 5, 6103);
        
        WaitFixedTimeSeconds(2);
        DeleteAssetfollowingSFX(X4_4, true);
        ShootBullet(X0_4, X4_4, 4, 105000, 0, 0, 0);
        WaitFixedTimeSeconds(0.3);
        ShootBullet(X0_4, X4_4, 5, 105010, 0, 0, 0);
        
        leftBulletHit |= CharacterHasSpEffect(10000, 9000051);
        rightBulletHit |= CharacterHasSpEffect(10000, 9000052);
        WaitFor(ElapsedSeconds(2) || leftBulletHit || rightBulletHit);
        if (leftBulletHit.Passed) {
            AwardItemLot(9990500);
            WaitFor(ElapsedSeconds(1.7) || rightBulletHit);
            AwardItemLot(9990510);
        }
        else if (rightBulletHit.Passed) {
            AwardItemLot(9990510);
            WaitFor(ElapsedSeconds(1.7) || leftBulletHit);
            AwardItemLot(9990500);
        }
        else {
            AwardItemLot(9990500);
    ...
    else { // If only one weapon was duplicated
        CreateAssetfollowingSFX(X4_4, 3, 331701);
        
        if (CompareEventValue(1099002020, 4, Equal, 1))
            CreateAssetfollowingSFX(X4_4, 3, 6101);
        else if (CompareEventValue(1099002020, 4, Equal, 2))
            CreateAssetfollowingSFX(X4_4, 3, 6102);
        else if (CompareEventValue(1099002020, 4, Equal, 3))
            CreateAssetfollowingSFX(X4_4, 3, 6103);
        else if (CompareEventValue(1099002010, 4, Equal, 1))
            CreateAssetfollowingSFX(X4_4, 3, 6101);
        else if (CompareEventValue(1099002010, 4, Equal, 2))
            CreateAssetfollowingSFX(X4_4, 3, 6102);
        else if (CompareEventValue(1099002010, 4, Equal, 3))
        ...
        WaitFixedTimeSeconds(2);
        DeleteAssetfollowingSFX(X4_4, true);
        ShootBullet(X0_4, X4_4, 3, 105000, 0, 0, 0);
        
        bulletHit |= CharacterHasSpEffect(10000, 9000051);
        WaitFor(bulletHit || ElapsedSeconds(3.2));
        AwardItemLot(9990500);
        AwardItemLot(9990510);
    }
    SetEventFlagID(X8_4, ON);
L0:
    WaitFixedTimeSeconds(1);
    const sfx = 640000;
    SpawnOneshotSFX(TargetEntityType.Character, X0_4, 60, sfx);
    SpawnOneshotSFX(TargetEntityType.Character, X0_4, 61, sfx);
    SpawnOneshotSFX(TargetEntityType.Character, X0_4, 63, sfx);
    SpawnOneshotSFX(TargetEntityType.Character, X0_4, 64, sfx);
    SpawnOneshotSFX(TargetEntityType.Character, X0_4, 65, sfx);
    SpawnOneshotSFX(TargetEntityType.Character, X0_4, 66, sfx);
    SpawnOneshotSFX(TargetEntityType.Character, X0_4, 67, sfx);
    SpawnOneshotSFX(TargetEntityType.Character, X0_4, 68, sfx);
    SpawnOneshotSFX(TargetEntityType.Character, X0_4, 71, sfx);
    SpawnOneshotSFX(TargetEntityType.Character, X0_4, 72, sfx);
    SpawnOneshotSFX(TargetEntityType.Character, X0_4, 73, sfx);
    SpawnOneshotSFX(TargetEntityType.Character, X0_4, 74, sfx);
    SpawnOneshotSFX(TargetEntityType.Character, X0_4, 75, sfx);
    EndEvent();
});
...
// One Time Kill Handler - EventFlag, EntityID, Item (optional)
...
// Door Key Obj Act Handler - Door open Eventflag, Key Goods, EntityID, ActionButton, FailMessage, SuccesMsg, Player Anim, Asset Dummypoly, Asset Opening Anim, Asset Opened anim, Optional Interact Point
$Event(20000344, Default, function(X0_4, X4_4, X8_4, X12_4, X16_4, X20_4, X24_4, X28_4, X32_4, X36_4, X40_4) {
    if (EventFlag(X0_4)) {
        ReproduceAssetAnimation(X8_4, X36_4);
        EndEvent();
    }
    
    if (Signed(X40_4) != 0)
        WaitFor(ActionButtonInArea(X12_4, X40_4))
    else
        WaitFor(ActionButtonInArea(X12_4, X8_4))
    
    if (!PlayerHasItem(ItemType.Goods, X4_4)) {
        DisplayGenericDialog(X16_4, PromptType.YESNO, NumberofOptions.NoButtons, 10000, 1);
        WaitFixedTimeSeconds(1);
        RestartEvent();
    }
    
    // If player anim is set
    if (Signed(X24_4) > 0) {
        IssueShortWarpRequest(10000, TargetEntityType.Asset, X8_4, X28_4);
        WaitFixedTimeFrames(1);
        RotateCharacter(10000, X8_4, -1, false);
        ForceAnimationPlayback(10000, X24_4, false, false, true);
    }
    ForceAnimationPlayback(X8_4, X32_4, false, false, true);
    SetEventFlagID(X0_4, ON);
    EndIf(Signed(X20_4) <= 0);
