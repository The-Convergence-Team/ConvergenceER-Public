...
$Event(0, Default, function() {
    ...
    InitializeEvent(0, 1037480350, 0);
    InitializeCommonEvent(0, 90006800, 1037487200, 1037481115);
});
...
$Event(200, Default, function() {
    ...
    InitializeCommonEvent(2, 9006900, 1037480400, 1037481418, 1037489200); // Weapon Duplication at the Walking Masoleum
});
...
// Wolf Interact for Class Note
$Event(1037480350, Default, function() {
    if (EventFlag(1037487110)) {
        DisableCharacter(1037480201);
        ForceCharacterDeath(1037480201, false);
        EndEvent();
    }
    DisableCharacterAI(1037480201);
    WaitFor(ActionButtonInArea(6256, 1037480201));
    AwardItemLot(1037480110);
    
    WaitFixedTimeSeconds(1);
    EnableCharacterAI(1037480201);
    WaitFixedTimeFrames(128);
    ForceAnimationPlayback(1037480201, 1751, true, true, false);
