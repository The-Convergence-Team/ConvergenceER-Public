...
$Event(1051572800, Default, function() {
    ...
    SetEventFlagID(1051570800, ON);
    SetEventFlagID(9184, ON);
    if (PlayerIsInOwnWorld()) {
        SetEventFlagID(61184, ON);
    }
});
...
L0:
    EnableCharacterInvincibility(1051570800);
...
L2:
    DisableCharacterInvincibility(1051570800);
...
$Event(200, Default, function() {
    ...
    InitializeCommonEvent(0, 9006900, 1251570400, 1251571418, 1051579200); // Weapon Duplication at the Walking Masoleum
});
