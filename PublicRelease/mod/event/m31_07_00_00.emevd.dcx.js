...
$Event(31072800, Restart, function() {
    ...
    WaitFor(CharacterDead(31070800));
    HandleBossDefeatAndDisplayBanner(31070800, TextBannerType.EnemyFelled);
    SetEventFlagID(31070800, ON);
    SetEventFlagID(9239, ON);
    if (PlayerIsInOwnWorld()) {
        SetEventFlagID(61239, ON);
    }
});
...
L0:
    ...
    EnableCharacterInvincibility(31070800);
...
L2:
    ...
    DisableCharacterInvincibility(31070800);
...
$Event(31072860, Default, function() {
    WaitFor(EventFlag(31070800));
    CreateAssetfollowingSFX(31070875, 200, 806870);
    IfActionButtonInArea(MAIN, 9140, 31070875);
    RotateCharacter(10000, 31070875, -1, true);
    ForceAnimationPlayback(10000, 60490, false, false, false, Equal, 1);
    WaitFixedTimeSeconds(3);
    WarpPlayer(12, 1, 0, 0, 12010886, 60);
    RestartEvent();
});
