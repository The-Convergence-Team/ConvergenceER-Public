...
$Event(0, Default, function() {
    ...
    InitializeEvent(0, 12022822, 0); //Caimar 2nd phase
    InitializeEvent(0, 12022849, 0);
    InitializeEvent(0, 12023750, 0);
    InitializeEvent(0, 12023751, 0);
    InitializeEvent(0, 12023752, 0);
    InitializeEvent(0, 12022850, 0);
    InitializeEvent(0, 12022857, 0);
    ...
    InitializeEvent(27, 12022300, 12025326, 12022314, 1097859072);
    ...
    //Transform Attacks - Enemy, SpEffect, Anim
    InitializeEvent(0, 12020551, 12020802, 11742, 3016, 3015, 260);
    InitializeEvent(1, 12020551, 12020803, 11743, 3006, 3007, 260);
    InitializeEvent(0, 12020553, 12020802, 260);
    InitializeEvent(1, 12020553, 12020803, 220);
    InitializeEvent(0, 12022830, 12020802, 11742);
    InitializeEvent(1, 12022830, 12020803, 11743);
    InitializeEvent(0, 12020556, 12020803, 11743);
    
    //Wolf Summon - Enemy, SpEffect, Attack Anim 1, Attack Anim 2
    InitializeEvent(0, 12020555, 12020801, 11741, 3004, 3005);
    ...
    InitializeEvent(2, 12020610, 12020625, 12023620, 12024617, 12024618, 12024619);
...
$Event(12022899, Restart, function() {
    ...
    InitializeCommonEvent(0, 9005822, 12020850, 921600, 12022855, 12022856, 0, 12022852, 0, 0);
});
...
$Event(12022800, Restart, function() {
    ...
    SetEventFlagID(12025840, ON); //music handler death event
    ...
    WaitFixedTimeSeconds(6);
    SetEventFlagID(12025840, OFF); //music handler eventflag
});
...
$Event(12022830, Restart, function(X0_4, X4_4) {
    EndIf(EventFlag(12020800));
    WaitFor(CharacterHasSpEffect(12020800, X4_4) && InArea(12020800, 12022807) && InArea(X0_4, 12022807));
    timerExpired |= ElapsedSeconds(1.5);
    WaitFor(!InArea(12020800, 12022807) || !InArea(X0_4, 12022807) || timerExpired);
...
$Event(12022849, Restart, function() {
    ...
    //InitializeCommonEvent(0, 9005822, 12020800, 467000, 12022807, 12022806, 0, 12022802, 0, 0);
});
...
L0:
    ...
    WaitFor(ElapsedSeconds(3) || HasDamageType(12020870, 10000, DamageType.Unspecified) || EntityInRadiusOfEntity(12020870, 10000, 8, 1));
...
//Dummy Enemies
$Event(12020550, Restart, function(X0_4) {
    DisableCharacter(X0_4);
...
//Transform Attacks - Enemy, SpEffect, Anim, Idle Anim
$Event(12020551, Restart, function(X0_4, X4_4, X8_4, X12_4, X16_4) {
    DisableCharacter(X0_4);
    EndIf(EventFlag(12020800));
    ...
    DisableCharacterCollision(12020800);
    EnableCharacter(X0_4);
    ForceAnimationPlayback(X0_4, X8_4, false, false, false, Equal, 1);
    //WaitFixedTimeFrames(1);
    WarpCharacterAndCopyFloor(X0_4, TargetEntityType.Character, 12020800, 260, 12020800);
    ForceAnimationPlayback(12020800, 3037, true, false, false, Equal, 1);
    //IssueShortWarpRequest(12020800, TargetEntityType.Area, 12022805, -1);
    
    WaitFor(CharacterHasSpEffect(X0_4, X4_4));
    ForceAnimationPlayback(12020800, 3025, false, false, false, Equal, 1);
    WaitFixedTimeFrames(1);
    //EnableLockOnPoint(12020800, 220);
    EnableCharacterCollision(12020800);
    EnableCharacterGravity(12020800);
    IssueShortWarpRequest(12020800, TargetEntityType.Character, X0_4, X16_4);
    RequestCharacterAIReplan(12020800);
    
    ForceAnimationPlayback(X0_4, X12_4, true, false, false, Equal, 1);
    WaitFixedTimeFrames(2);
    WarpCharacterAndCopyFloor(X0_4, TargetEntityType.Area, 12022805, -1, 12022805);
    RestartEvent();
});

//Transform Teleporting - Enemy, SpEffect, Anim, Idle Anim
$Event(12020553, Restart, function(X0_4, X4_4) {
    EndIf(EventFlag(12020800));
    WaitFor(CharacterHasSpEffect(X0_4, 11744));
    //WaitFixedTimeFrames(1);
    WaitFixedTimeRealFrames(1);
    WarpCharacterAndCopyFloor(12020800, TargetEntityType.Character, X0_4, X4_4, X0_4);
    RestartEvent();
});

//Wolf Summon - Enemy, SpEffect, Attack Anim 1, Attack Anim 2
$Event(12020555, Restart, function(X0_4, X4_4, X8_4, X12_4) {
    WarpCharacterAndCopyFloor(X0_4, TargetEntityType.Area, 12022805, -1, 12020800);
    DisableLockOnPoint(X0_4, 220);
    DisableCharacterGravity(X0_4);
    DisableCharacterCollision(X0_4);
    //DisableCharacter(X0_4);
    EndIf(EventFlag(12020800));
    EnableCharacterImmortality(X0_4);
    BatchSetEventFlags(12025810, 12025811, OFF);
    ...
    RandomlySetEventFlagInRange(12025810, 12025811, ON);
    if (EventFlag(12025810)) {
        ForceAnimationPlayback(X0_4, X8_4, false, false, false, Equal, 1);
    }
    else {
        ForceAnimationPlayback(X0_4, X12_4, false, false, false, Equal, 1);
    }
...
// Bear Trap
$Event(12020556, Restart, function(X0_4, X4_4) {
    WaitFor(!InArea(X0_4, 12022807));
    animationFailure |= ElapsedFrames(60);
    WaitFor(CharacterHasSpEffect(X0_4, 11744) || animationFailure);
...
//Bridge Crystals - EventFlag, Crystal, Bridge Piece 1, Bridge Piece 2, VFX
$Event(12020610, Restart, function(X0_4, X4_4, X8_4, X12_4, X16_4) {
    if (EventFlag(X0_4)) {
        RequestAssetDestruction(X4_4, 0);
        DeleteAssetfollowingSFX(X4_4, false);
        DisableMapPart(X8_4);
        DisableMapPart(X12_4);
        DeleteMapSFX(X16_4, true);
        SpawnMapSFX(X16_4);
        EndEvent();
    }
    CreateAssetfollowingSFX(X4_4, 200, 650014);
    DeleteMapSFX(X16_4, true);
    DisableAsset(X8_4);
    DisableAsset(X12_4);
...
L0:
    if (PlayerIsInOwnWorld()) {
        WaitFor(ActionButtonInArea(6231, X4_4) && PlayerIsInOwnWorld());
        RotateCharacter(10000, X4_4, -1, true);
        ...
        RequestAssetDestruction(X4_4, 0);
        SpawnOneshotSFX(TargetEntityType.Asset, X4_4, 200, 650015);
    }
L10:
    WaitFor(EventFlag(X0_4));
    DeleteAssetfollowingSFX(X4_4, false);
...
$Event(12020680, Restart, function(X0_4, X4_4, X8_4, X12_4, X16_4, X20_4, X24_4) {
    DisableCharacter(X0_4);
    DisableLockOnPoint(X0_4, 220);
    EnableCharacterFadeOnEnable(X0_4);
    EnableCharacterInvincibility(X0_4);
    WaitFor(InArea(10000, X4_4));
    WaitRandomTimeFrames(X16_4, X20_4);
    EnableCharacter(X0_4);
    if (Signed(X24_4) > 0)
        IssueShortWarpRequest(X0_4, TargetEntityType.Character, 10000, X24_4);
    RotateCharacter(X0_4, 10000, -1, false);
    ForceAnimationPlayback(X0_4, X8_4, false, false, true);
    PlaySE(X0_4, SoundType.CharacterMotion, 999997800);
    WaitFixedTimeFrames(X12_4);
    SetSpEffect(X0_4, 10124); // Fade
    PlaySE(X0_4, SoundType.CharacterMotion, 999997801);
...
$Event(12020695, Restart, function(X0_4, X4_4, X8_4, X12_4, X16_4) {
    if (EventFlag(X0_4)) {
        DisableCharacter(X0_4);
        DisableCharacterCollision(X0_4);
        ForceCharacterDeath(X0_4, false);
    ...
    SetCharacterTeamType(X0_4, 0);
    SetSpEffect(X0_4, 13145);
    DisableCharacterAI(X0_4);
    WaitFor(InArea(10000, X4_4));
    ...
    SetSpEffect(X0_4, 10124);
    SpawnOneshotSFX(TargetEntityType.Character, X0_4, 905, 680000);
    SpawnOneshotSFX(TargetEntityType.Character, X0_4, 960, 680000);
    PlaySE(X0_4, SoundType.CharacterMotion, 800020000);
    WaitFixedTimeFrames(22);
    DisableCharacter(X0_4);
    DisableCharacterCollision(X0_4);
    ForceCharacterDeath(X0_4, false);
