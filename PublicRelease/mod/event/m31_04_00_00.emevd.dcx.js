...
$Event(0, Default, function() {
    ...
    InitializeEvent(0, 31042418, 0);
    InitializeCommonEvent(0, 90005646, 31040800, 31042840, 31042841, 31041840, 31042840, 1055);
    InitializeCommonEvent(0, 90005211, 31040325, 30000, 31042325, 0, 0, 1, 0, 0, 0);
    RegisterLadder(31040281,31041282,31041281); // new ladder
    InitializeCommonEvent(0, 90005250, 31040401, 31040402, 0, 3022); // Firebomb 1
    InitializeCommonEvent(0, 90005250, 31040403, 31040404, 0, 3022); // Firebomb 2
    InitializeCommonEvent(0, 90005250, 31040405, 31040406, 0, 3016); // Corpse Jumpscare 1
    InitializeCommonEvent(0, 90005250, 31040407, 31040408, 0, -1); // Kindred Stuff
    InitializeCommonEvent(0, 90005250, 31040409, 31040410, 0, -1); // Kindred Stuff
    InitializeCommonEvent(0, 90005250, 31040411, 31040412, 0, 3016); // Corpse Jumpscare 2
    InitializeCommonEvent(0, 90005250, 31040413, 31040406, 0, 3004); // Baby Pest Jumpscare 1
    InitializeCommonEvent(0, 90005250, 31040414, 31040425, 0, -1); // Fingers Crossed enemy activation
    InitializeCommonEvent(0, 90005250, 31040415, 31040416, 0, -1); // Kindred Stuff

    InitializeCommonEvent(0, 90005250, 31040426, 31040425, 0, -1); // Fingers Crossed enemy activation
    InitializeCommonEvent(0, 90005250, 31040427, 31040425, 0, -1); // Fingers Crossed enemy activation
    InitializeCommonEvent(0, 90005250, 31040428, 31040425, 0, -1); // Fingers Crossed enemy activation
    InitializeCommonEvent(0, 90005250, 31040429, 31040436, 0, 20000); // Corpse Activatin
    InitializeCommonEvent(0, 90005250, 31040430, 31040436, 0, 20000); // Corpse Activatin 
    InitializeCommonEvent(0, 90005250, 31040432, 31040431, 0, -1); // Fingers Crossed enemy activation
    InitializeCommonEvent(0, 90005250, 31040433, 31040431, 0, -1); // Fingers Crossed enemy activation
    InitializeCommonEvent(0, 90005250, 31040434, 31040431, 0, -1); // Fingers Crossed enemy activation  
...
$Event(50, Default, function() {
    ...
    InitializeEvent(9, 31040326, 31040325);
    InitializeCommonEvent(0, 90005525, 31040813, 31041813); //illusory wall
...
$Event(31042800, Restart, function() {
    ...
    SetEventFlagID(31040800, ON);
    SetEventFlagID(9236, ON);
    if (PlayerIsInOwnWorld()) {
        SetEventFlagID(61236, ON);
    }
});
...
L0:
    ...
    EnableCharacterInvincibility(31040800);
...
L2:
    ...
    DisableCharacterInvincibility(31040800);
...
$Event(31040326, Restart, function() {
    EnableAssetInvunerability(31040280); //light
    EnableAssetInvunerability(31040283); //light
    EnableAssetInvunerability(31040284); //light
    EnableAssetInvunerability(31040285); //light
    DisableMapPart(31040286) //wall to prevent stuck
    DisableMapPart(31040287) //wall to prevent stuck
    DisableHit(31040288)//resized wall
    DisableHit(31040289)//resized wall
    DisableHit(31040290)//resized wall
    DisableHit(31040291)//resized wall
    DisableHit(31040292)//resized wall
    DisableHit(31040293)//resized wall
    DisableMapPart(31040294) //wall to prevent stuck
    DisableMapPart(31040295) //wall to prevent stuck
    DisableMapPart(31040296) //wall to prevent stuck
    DisableMapPart(31040297) //wall to prevent stuck
});
$Event(31042418, Restart, function() { //Corpse Party. Thanks EXE
    WaitFor(InArea(10000, 31040418));
    
    ForceAnimationPlayback(31040417, 20000, false, false, false);
    WaitRandomTimeFrames(10, 30);
    ForceAnimationPlayback(31040419, 20000, false, false, false);
    WaitRandomTimeFrames(10, 30);
    ForceAnimationPlayback(31040420, 20000, false, false, false);
    WaitRandomTimeFrames(10, 30);
    ForceAnimationPlayback(31040421, 20000, false, false, false);
    WaitRandomTimeFrames(10, 30);
    ForceAnimationPlayback(31040422, 20000, false, false, false);
    WaitRandomTimeFrames(10, 30);
    ForceAnimationPlayback(31040423, 20000, false, false, false);
    WaitRandomTimeFrames(10, 30);
