...
$Event(0, Default, function() {
    ...
    InitializeCommonEvent(0, 9005810, 12050850, 12050004, 12050954, 12051954, 1084227584);
    InitializeEvent(0, 12052800, 0);
    InitializeEvent(0, 12052810, 0);
    InitializeEvent(0, 12052811, 0);
    InitializeEvent(0, 12052815, 12052836); //Mohg Teleport safety areas
    InitializeEvent(1, 12052815, 12052831); //Mohg Teleport safety areas
    InitializeEvent(2, 12052815, 12052832); //Mohg Teleport safety areas
    InitializeEvent(3, 12052815, 12052833); //Mohg Teleport safety areas
    InitializeEvent(4, 12052815, 12052834); //Mohg Teleport safety areas
    InitializeEvent(5, 12052815, 12052835); //Mohg Teleport safety areas
    ...
    //InitializeCommonEvent(0, 90005792, 12050410, 12052410, 12052411, 12050410, 12050910, 0);
    ...
    //InitializeCommonEvent(0, 90005792, 12050414, 12052414, 12052415, 12050414, 12050910, 0);
    ...
    if (EventFlagState(ON, 0, 12050850)) {
    ...
    InitializeCommonEvent(0, 90005615, 12052699, 12050800);
    ...
    InitializeEvent(0, 12050700, 12050750, 4440, 4443, 4445, 90100, 12059261); //Warp to Siofra
    InitializeCommonEvent(0, 98005307, 12051660, 12, 2, 0, 0, 12021661, 0); // Waygate
    ...
    InitializeCommonEvent(0, 90005250, 12050425, 12052425, 0, -1); //npc Parky encounter
...
$Event(50, Default, function() {
    ...
    InitializeEvent(0, 12052500, 0);
});

$Event(12052230, Restart, function() {
    SetCharacterEnableDistanceAndUnknown200484(12050810, 220, 40);
});

// Blood Smoke Statues - ActivationRegion, SourceRegion, BulletDummy
$Event(12052235, Restart, function(X0_4, X4_4) {
    DisableNetworkSync();
    CreateBulletOwner(X4_4);
    WaitFor(EntityInRadiusOfEntity(10000, X0_4, 4, 1));
    SpawnOneshotSFX(TargetEntityType.Asset, X0_4, 201, 4226);
    PlaySE(X0_4, SoundType.SFX, 305033);
    WaitFixedTimeSeconds(0.2);
    ShootBullet(X4_4, X0_4, 200, 803500000, -30, 0, 0);
    WaitFixedTimeSeconds(5);
    RestartEvent();
});

//Varre Invasion - Fogwalls
...
$Event(12052500, Restart, function() {
    EndIf(!PlayerIsInOwnWorld());
    SetEventFlagID(12052501, OFF);
    SetEventFlagID(12052502, OFF);
    WaitFor(
        EventFlag(6951)
            && PlayerIsInOwnWorld()
            && EventFlag(9112)
            && EventFlag(9130)
            && ActionButtonInArea(209500, 12051500));
    DisplayGenericDialogAndSetEventFlags(2020000, PromptType.YESNO, NumberofOptions.TwoButtons, 12051500, 3, 12052501, 12052502, 12052502);
    if (!EventFlag(12052501)) {
        WaitFixedTimeSeconds(3);
        RestartEvent();
    }
L0:
    ...
    RotateCharacter(10000, 12052500, 60550, false);
...
L0:
    ...
    EnableCharacterInvincibility(12050800);
...
L2:
    ...
    DisableCharacterInvincibility(12050800);
    ...
    ForceAnimationPlayback(12050800, 3038, false, false, false); //Mohg warp test
    WaitFor(CharacterHasSpEffect(12050800, 10610) && CharacterHasSpEffect(12050800, 10610));
    WarpCharacterAndCopyFloor(12050800, TargetEntityType.Area, 12052807, -1, 10000);
});
...
$Event(12052815, Restart, function(X0_4) {
    EndIf(EventFlag(12050800));
    WaitFor(InOutsideArea(InsideOutsideState.Inside, 12050800, X0_4));
    WaitFixedTimeSeconds(4);
    WarpCharacterAndCopyFloor(12050800, TargetEntityType.Area, 12052807, -1, 10000);
});
...
$Event(12052840, Restart, function() {
    EndIf(EventFlag(12050850));
    WaitFor(CharacterHPValue(12050850) <= 0);
    WaitFixedTimeSeconds(4);
    PlaySE(12050850, SoundType.SFX, 888880000);
    WaitFor(
    (PlayerIsInOwnWorld() && CharacterDead(12050850))
    || EventFlag(12050850));
    HandleBossDefeatAndDisplayBanner(12050850, TextBannerType.GreatEnemyFelled);
    if (PlayerIsInOwnWorld()) {
        TriggerMultiplayerEvent(0);
    }
...
$Event(12052841, Restart, function() {
    if (EventFlag(12050850)) {
        DisableCharacter(12050850);
        DisableCharacterCollision(12050850);
        ForceCharacterDeath(12050850, false);
        EndEvent();
    }
L0:
    DisableCharacterAI(12050850);
    EnableCharacterInvincibility(12050850);
    if (!EventFlag(12050851)) {
        WaitFor(
            (PlayerIsInOwnWorld() && InArea(10000, 12052851))
            || HasDamageType(12050850, 10000, DamageType.Unspecified));
            SetNetworkconnectedEventFlagID(12050851, ON);
        if (PlayerIsInOwnWorld()) {
            SendInvadingPhantomsHome(0);
        }
        //WaitFixedTimeRealFrames(1);
...
L1:
        DisableCharacterCollision(12050850);
        WaitFor(EventFlag(12052855) && InArea(10000, 12052850));
        EnableCharacterCollision(12050850);
    }
L2:
    EnableCharacterAI(12050850);
    DisableCharacterInvincibility(12050850);
    SetNetworkUpdateRate(12050850, true, CharacterUpdateFrequency.AlwaysUpdate);
...
$Event(12050700, Restart, function(X0_4, X4_4, X8_4, X12_4, X16_4, X20_4) {
    DisableNetworkSync();
    WaitFixedTimeFrames(1);
    if (PlayerIsInOwnWorld()) {
    }
