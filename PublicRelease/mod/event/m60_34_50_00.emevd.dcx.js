...
$Event(0, Default, function() {
    ...
    $InitializeCommonEvent(0, 900005590, 6953, 1034501601, 1034508601);
    ...
    InitializeEvent(0, 1034502615, 0);
    InitializeEvent(0, 1034502616, 0);
    InitializeCommonEvent(0, 90005501, 1034500310, 1034500311, 0, 1034501310, 1034501311, 1034501312, 1034500312); // Caria Rise Elevator
    InitializeCommonEvent(0, 90005501, 1034500410, 1034500411, 0, 1034501410, 1034501411, 1034501412, 1034500412); // Caria Rise Elevator
    
    InitializeCommonEvent(0, 90006800, 1034507300, 1034500110);
});
...
$Event(1034502580, Default, function() {
    ...
    RegisterLadder(1034500590,1034500591,1034501590);   //scaffold_ladder
});
...
$Event(1034502510, Restart, function() {
    ...
    InitializeCommonEvent(0, 90005500, 1034500310, 1034500311, 0, 1034501310, 1034501311, 1034503311, 1034501312, 1034503312, 1034502312, 1034502313, 1034500312, 1034500313, 0); // Elevator
    InitializeCommonEvent(0, 90005500, 1034500410, 1034500411, 0, 1034501410, 1034501411, 1034503411, 1034501412, 1034503412, 1034502412, 1034502413, 1034500412, 1034500413, 0); // Elevator
});
...
$Event(1034502615, Restart, function() {
    WaitFor(EventFlag(1034500625));
    CreateAssetfollowingSFX(1034501625, 200, 806870);
    IfActionButtonInArea(MAIN, 9140, 1034501625);
    RotateCharacter(10000, 1034501625, -1, true);
    ForceAnimationPlayback(10000, 60490, false, false, false, Equal, 1);
    WaitFixedTimeSeconds(3);
    WarpPlayer(60, 44, 36, 0, 1044361661, 60);
    SaveRequest();
    SetPlayerRespawnPoint(1044361661);
    RestartEvent();
});
$Event(1034502616, Restart, function() {
    EndIf(EventFlag(1034500625));
    WaitFor(EventFlag(3767));
    SetEventFlagID(1034500625, ON);
});
