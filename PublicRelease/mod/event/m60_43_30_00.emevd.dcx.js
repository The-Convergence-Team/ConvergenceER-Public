...
$Event(1043302849, Restart, function() {
    ...
    InitializeCommonEvent(0, 9005822, 1043300800, 392000, 1043302805, 1043302806, 0, 0, 0, 0);
...
$Event(1043302949, Restart, function() {
    ...
    InitializeCommonEvent(0, 9005811, 1043300820, 1043301822, 17, 0);
    InitializeCommonEvent(0, 9005811, 1043300820, 1043301823, 17, 0);
    InitializeCommonEvent(0, 9005822, 1043300820, 392100, 1043302826, 1043302827, 0, 0, 0, 0);
});
