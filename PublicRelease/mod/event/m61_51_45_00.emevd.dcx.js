...
$Event(0, Default, function() {
    ...
    InitializeEvent(0, 2051450726, 2051450720, 4503, 4500, 4504, 2051450800);
...
$Event(250, Default, function() {
    ...
    InitializeCommonEvent(0, 90005438, -2043517016);
});
...
L10:
    ...
    SetEventFlagID(2051450800, ON);
    SetNetworkconnectedEventFlagID(2051452820, OFF);
...
$Event(2051452601, Restart, function() {
    DisableNetworkSync();
    EndIf(PlayerIsInOwnWorld());
    WaitFor(EventFlag(2051452602) && CharacterBackreadStatus(25000800));
...
$Event(2051450726, Restart, function(X0_4, X4_4, X8_4, X12_4, X16_4) {
    EndIf(!PlayerIsInOwnWorld());
    WaitFixedTimeFrames(1);
    EndIf(EventFlag(X4_4) && EventFlag(X16_4));
    WaitFor(!EventFlag(X4_4) && CharacterDead(X0_4) && EventFlag(X16_4));
