...
L0:
    if (!EventFlag(28000801)) {
        ...
        WaitFor(EventFlag(28000814)); // Fogwall
    } else {
L1:
...
L0:
    ...
    if (!EventFlag(28000801)) {
        WaitFor(EventFlag(28000801));
    }
    else {
        SetEventFlagID(28002804, ON);
        SetSpEffect(28000800, 20010268); // Head glow
        //SetEventFlagID(28002705, ON); // Disable reuse of Depths of your Foolishness
    }
    ...
    if (!EventFlag(28002804)) {
        WaitFixedTimeSeconds(5);
    }
    GotoIf(L1, !EventFlag(28002803));
...
L1:
    ...
    DisableCharacter(28000801);
    DisableCharacterAI(28000800);
    WarpCharacterAndCopyFloor(28000800, TargetEntityType.Area, 28002812, -1, 28000801);
    EnableCharacterGravity(28000800);
    EnableCharacterCollision(28000800);
    EnableCharacterInvincibility(28000800);
        
    WaitFor(EventFlag(28002805) && ElapsedFrames(1));
    DisableCharacterInvincibility(28000800);
    if (!EventFlag(28002804))
