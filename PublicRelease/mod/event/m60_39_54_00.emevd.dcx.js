...
$Event(50, Default, function() {
    ...
    InitializeCommonEvent(0, 90005300, 1039540555, 1039540555, 108400, 0, 0); // Loreena NPC reward
});
...
$Event(1039542800, Restart, function() {
    ...
    SetEventFlagID(1039540800, ON);
    SetEventFlagID(9182, ON);
    if (PlayerIsInOwnWorld()) {
        SetEventFlagID(61182, ON);
    }
});
...
L0:
    ...
    EnableCharacterInvincibility(1039540800);
    ...
    DisableCharacterInvincibility(1039540800);
