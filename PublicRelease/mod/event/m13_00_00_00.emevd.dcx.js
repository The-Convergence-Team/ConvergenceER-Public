...
$Event(0, Default, function() {
    ...
    InitializeCommonEvent(0, 90005300, 13000494, 13000494, 0, 4, 0); //boss defeat script Lansseax
    InitializeEvent(2, 13002493, 13000494, 13002645, 13002494);
    InitializeEvent(1, 13002646, 13000494, 13002646, 13000494, 1092616192);
    //InitializeEvent(0, 13002610, 0); dragon call lightning events
    ...
    //InitializeEvent(0, 13002660, 13000180, 13002181, 13002182, 13000710, 13002180, 13002183, 0);
    ...
    InitializeEvent(0, 13002550, 13000703, 13007045, 1, 30010, 20010); //dragon wake up script
    //Custom Killbox
    InitializeCommonEvent(0, 9005999, 13002265);
    //Ambush Triggers || Area, Enemy, Anim
    InitializeEvent(0, 13003784, 13002267, 13001267, 3001);
    //Alert (Horn) Trigger || Horn boi, Enemy to be Activated
    InitializeEvent(0, 13003787, 13001268, 13001269);
    InitializeEvent(1, 13003787, 13001268, 13001270);
    InitializeEvent(2, 13003787, 13001271, 13001272);
    ...
    //Sleepy Courtyard Ancient Dragon One Time Kill Handler Initialzation
    InitializeCommonEvent(0, 90005300, 13000703, 13000703, 0);
});
...
$Event(50, Default, function() {
    ...
    InitializeCommonEvent(0, 90005250, 13000210, 13002210, 0, 3002); //modified anim from 3001
    InitializeCommonEvent(0, 90005250, 13000208, 13002255, 0, 3002); //suprise attack
    InitializeCommonEvent(0, 90005250, 13000244, 13002256, 0, 3002); //suprise attack
    InitializeCommonEvent(0, 90005250, 13000497, 13002258, 0, 3002); //suprise attack
    ...
    InitializeCommonEvent(0, 90005271, 13000212, 0, -1); //activate upon damage
    InitializeCommonEvent(0, 90005271, 13000248, 0, -1); //activate upon damage
    ...
    InitializeCommonEvent(0, 90005200, 13000419, 30018, 20018, 13002418, 0, 0, 0, 0, 0);
    InitializeCommonEvent(0, 90005200, 13000243, 30018, 20018, 13002259, 1085276160, 0, 0, 0, 0);
    InitializeCommonEvent(0, 90005200, 13000242, 30018, 20018, 13002259, 1085276160, 0, 0, 0, 0);
    InitializeCommonEvent(0, 90005200, 13000241, -1, -1, 13002259, 0, 0, 0, 0, 0);
    InitializeCommonEvent(0, 90005200, 13000255, -1, -1, 13002266, 0, 0, 0, 0, 0);
    InitializeCommonEvent(0, 90005200, 13000256, -1, -1, 13002266, 0, 0, 0, 0, 0);
    InitializeCommonEvent(0, 90005200, 13000257, -1, -1, 13002266, 0, 0, 0, 0, 0);
    InitializeCommonEvent(0, 90005200, 13000240, 30018, 20018, 13002261, 0, 0, 0, 0, 0);
    ...
    //InitializeCommonEvent(0, 90005261, 13000502, 13002503, 1109393408, 0, -1);
    InitializeCommonEvent(0, 90005200, 13000502, 30018, 20018, 13002503, 1109393408, 0, 0, 0, 0);
    InitializeCommonEvent(0, 90005261, 13000503, 13002503, 1109393408, 0, -1);
    InitializeCommonEvent(0, 90005261, 13000504, 13002503, 1109393408, 0, -1);
    //EnemyAct New Skeleton Area Upper
    InitializeCommonEvent(0, 90005261, 13000505, 13002504, 1109393408, 0, -1);
    InitializeCommonEvent(0, 90005261, 13000506, 13002504, 1109393408, 0, -1);
    InitializeCommonEvent(0, 90005261, 13000507, 13002504, 1109393408, 0, -1);
    //EnemyAct Before Lansseax 1
    InitializeCommonEvent(0, 90005261, 13000508, 13002505, 1109393408, 0, -1);
    InitializeCommonEvent(0, 90005261, 13000509, 13002505, 1109393408, 0, -1);
    //Hide Asset but keep collision
    InitializeEvent(0, 13003786, 0);
    //InitializeEvent(0, 13003784, 0);
    //InitializeEvent(0, 13003785, 0);
    //Fall Immunity Area Between Lansseax and Placi - Fall Damage
    InitializeCommonEvent(0, 90005691, 13002722);
    //Fall Immunity Area Between Lansseax and Placi - Fall Immunity
    InitializeCommonEvent(0, 90005690, 13002722);
    //Fall Immunity Area Between Lansseax and Placi - Forced Asset Destruction
    InitializeEvent(0, 13012500, 0);
    //Kickdown Ladder
...
// Dragon Activation with treasure pickup - Enemy, treasure flag, SecondsTillAnim, ForcedAnim (default: -1)
$Event(13002550, Restart, function(X0_4, X4_4, X8_4, X12_4, X16_4) {
    EndIf(ThisEventSlot());
    ...
    sp5 = CharacterHasSpEffect(X0_4, 487)
        ...
        && !CharacterHasSpEffect(X0_4, 90160);
    areaChrSp = EventFlag(X4_4) && chrSp;
    WaitFor(
...
$Event(13002580, Restart, function() {
    ...
    RegisterLadder(13000592, 13000593, 13001592);
    RegisterLadder(13000594, 13000595, 13001594);
    RegisterLadder(13000596, 13000597, 13001596);
    RegisterLadder(13000598, 13000599, 13001595);
    RegisterLadder(13000603, 13000604, 13001597);
    RegisterLadder(13002602, 13002601, 13001602); //Kickdown Ladder
});
...
//New Elevator
$Event(13002787, Default, function() {
    InitializeCommonEvent(0, 90005500, 13000534, 13000535, 0, 13001534, 13001536, 13003537, 13001538, 13003539, 13002540, 13002541, 13000536, 13000537, 0);
});

$Event(13000788, Default, function() {
EndIf(ThisEventSlot());
SetEventFlagID(13000534, ON);
});

$Event(13000519, Default, function() {
    EndIf(ThisEventSlot());
    SetEventFlagID(13000510, ON);
    SetEventFlagID(13000530, ON);
    SetEventFlagID(13000515, ON);
    SetThisEventSlot(ON);
});
...
$Event(13002805, Restart, function() { //unused
    if (!EventFlag(13000800)) {
...
L0:
    ...
    DisableCharacterCollision(13000800);
    EnableCharacterInvincibility(13000800);
    EnableCharacterInvincibility(13000801);
...
L2:
    ...
    DisableCharacterInvincibility(13000800);
    DisableCharacterInvincibility(13000801);
...
$Event(13002850, Restart, function() {
    ...
    WaitFor(CharacterHPValue(13000855) <= 0);
    ForceCharacterDeath(13000855, false);
    ForceCharacterDeath(13000856, false);
    WaitFixedTimeSeconds(4);
    PlaySE(13000855, SoundType.SFX, 888880000);
    WaitFor(CharacterDead(13000855));
    HandleBossDefeatAndDisplayBanner(13000855, TextBannerType.GreatEnemyFelled);
    SetEventFlagID(13000850, ON);
    SetEventFlagID(13005845, ON); //music handler eventflag
    SetEventFlagID(13002852, OFF);
    SetEventFlagID(13002855, OFF);
    SetEventFlagID(9114, ON);
    if (PlayerIsInOwnWorld()) {
        SetEventFlagID(61114, ON);
    }
    WaitFixedTimeSeconds(6);
    SetEventFlagID(13005845, OFF); //music handler eventflag
});
...
L6:
    ...
    if (!EventFlag(13000851)) {
        DisableCharacter(13000855);
        DisableCharacter(13000856);
        ForceAnimationPlayback(13000855, 700, true, false, false);
        ForceAnimationPlayback(13000856, 700, true, false, false);
        WaitFor(
            (PlayerIsInOwnWorld() && InArea(10000, 13002851))
                || HasDamageType(13000855, 10000, DamageType.Unspecified)
                || HasDamageType(13000856, 10000, DamageType.Unspecified));
        SetNetworkconnectedEventFlagID(13000851, ON);
        EnableCharacter(13000855);
        ForceAnimationPlayback(13000855, 3008, false, false, false);
    } else {
L7:
        WaitFor(
            EventFlag(13002855)
...
L8:
    EnableCharacter(13000855);
    EnableCharacterAI(13000855);
    EnableCharacterCollision(13000855);
    SetNetworkUpdateRate(13000855, true, CharacterUpdateFrequency.AlwaysUpdate);
    DisplayBossHealthBar(Enabled, 13000855, 0, 903575000);
});

$Event(13002861, Restart, function() {
    EndIf(EventFlag(13000850));
    WaitFor(HPRatio(13000850) <= 0.5);
    SetEventFlagID(13002852, ON);
    SetEventFlagID(13002855, OFF);
});

$Event(13002890, Restart, function() {
});

$Event(13002891, Restart, function() {
});
...
//Lansseax events
$Event(13003780, Restart, function() {
    EndIf(EventFlag(13000860));
    WaitFor(CharacterHPValue(13000860) <= 0);
    ForceCharacterDeath(13000860, false);
    WaitFixedTimeSeconds(4);
    PlaySE(13000860, SoundType.SFX, 888880000);
    WaitFor(CharacterDead(13000860));
    HandleBossDefeatAndDisplayBanner(13000860, TextBannerType.GreatEnemyFelled);
    SetEventFlagID(13000860, ON);
    SetEventFlagID(9185, ON);
    if (PlayerIsInOwnWorld()) {
        SetEventFlagID(61185, ON);
    }
});


$Event(13003781, Restart, function() {
    if (EventFlag(13000860)) {
        DisableCharacter(13000860);
        DisableCharacterCollision(13000860);
        ForceCharacterDeath(13000860, false);
        EndEvent();
    }
L0:
    DisableCharacter(13000860);
    DisableCharacterAI(13000860);
    WaitFor(PlayerIsInOwnWorld() && InArea(10000, 13002645));
    EnableCharacter(13000860);
    EnableCharacterAI(13000860);
    SetNetworkUpdateRate(13000860, true, CharacterUpdateFrequency.AlwaysUpdate);
    EnableCharacterCollision(13000860);
    ForceAnimationPlayback(13000860, 20019, false, false, false);
...
//$Event(13003784, Restart, function() {
    //    WaitFor(CharacterHasSpEffect(13000860, 18640));
    //    EndIf(!CharacterHasSpEffect(13000860, 18640));
    //    SetCharacterImmortality(13000860, Enabled);
    //    RestartEvent();
//});

$Event(13003785, Restart, function() {
    WaitFor(!CharacterHasSpEffect(13000860, 18640));
    EndIf(CharacterHasSpEffect(13000860, 18640));
    SetCharacterImmortality(13000860, Disabled);
    RestartEvent();
});

//Hide Asset but Keep Collision
$Event(13003786, Restart, function() {
    DisableMapPart(13001701);
    DisableMapPart(13001702);
    DisableMapPart(13001703);
    DisableMapPart(13001704);
    DisableMapPart(13001705);
    DisableMapPart(13001706);
    DisableMapPart(13001707);
    DisableMapPart(13001708);
    DisableMapPart(13001709);
    DisableMapPart(13001710);
    DisableMapPart(13001711);
    DisableMapPart(13001712);
    DisableMapPart(13001713);
    DisableMapPart(13001714);
    DisableMapPart(13001715);
    DisableMapPart(13001716);
    DisableMapPart(13001718);
    DisableMapPart(13001719);
    DisableMapPart(13001720);
    DisableMapPart(13001721);
    DisableMapPart(13001722);
    DisableMapPart(13001723);
    DisableMapPart(13001724);
    DisableMapPart(13001725);
    DisableMapPart(13001726);
    DisableMapPart(13001727);
    DisableMapPart(13001728);
    DisableMapPart(13001729);
    DisableMapPart(13001730);
    DisableMapPart(13001731);
    DisableMapPart(13001732);
    DisableMapPart(13001733);
    DisableMapPart(13001734);
    DisableMapPart(13001735);
    DisableMapPart(13001736);
    DisableMapPart(13001737);
    DisableMapPart(13001738);
    DisableMapPart(13001739);
    DisableMapPart(13001746);
    DisableMapPart(13001747);
    DisableMapPart(13001748);
    DisableMapPart(13001749);
    DisableMapPart(13001750);
    DisableMapPart(13001751);
    DisableMapPart(13001752);
    DisableMapPart(13001753);
    DisableMapPart(13001754);
    DisableMapPart(13001755);
    DisableMapPart(13001756);
    DisableMapPart(13001757);
    DisableMapPart(13001758);
    DisableMapPart(13001760);
    DisableMapPart(13001762);
    DisableMapPart(13001763);
    DisableMapPart(13001764);
...
//Enemy uses Horn and wakes up others
//We check for SPeffect added via Animation (SP.10180 for Exile Soldiers)
$Event(13003787, Restart, function(X0_4, X4_4) {
    DisableCharacter(X4_4);
    WaitFor(CharacterHasSpEffect(X0_4, 10180));
    EnableCharacter(X4_4);
    //Enable fall damage immunity
    SetSpEffect(X4_4, 4085);
    WaitFixedTimeSeconds(10);
    ClearSpEffect(X4_4, 4085);
    EndEvent();
});
...
$Event(13012500, Restart, function() {
    if (EventFlag(13010500)) {
        DisableAsset(13011500);
        EndEvent();
    }
L0:
WaitFor(InArea(10000, 13012500));
RequestAssetDestruction(13011500, 1);
SetEventFlagID(13010500, ON);
});
