...
$Event(30142800, Restart, function() {
    ...
    SetEventFlagID(30140800, ON);
    if (PlayerIsInOwnWorld()) {
        SetEventFlagID(61214, ON);
    }
    SetEventFlagID(9214, ON);
});
...
L0:
    ...
    EnableCharacterInvincibility(30140800);
    EnableCharacterInvincibility(30140801);
    WaitFor(EventFlag(30142805) && InArea(10000, 30142800));
L2:
    EnableCharacterAI(30140800);
    DisableCharacterInvincibility(30140800);
    ...
    DisableCharacterInvincibility(30140801);
