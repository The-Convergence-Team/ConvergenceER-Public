...
$Event(0, Default, function() {
    ...
    InitializeEvent(0, 16001734, 0); //mimic invun
});
...
$Event(16001734, Default, function() { //mimic invunerability
    EndIf(EventFlag(16000850));
    EnableCharacterInvincibility(16000650);
    WaitFor(EventFlag(16000850));
    DisableCharacterInvincibility(16000650);
